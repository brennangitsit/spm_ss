...
workdir = '/Users/btc/Library/CloudStorage/OneDrive-UniversityCollegeLondon/SDSU_LLCN/LOC/6_Results/1-1_gcss_parcels/';
cd(workdir)
...
subjects = {...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-01/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-02/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-03/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-04/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-07/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-08/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-09/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-10/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-11/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-12/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-14/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-15/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-17/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-18/SPM.mat',...
    '/Volumes/BTCruiser/LOC/stats/4fwhm/sub-19/SPM.mat'...
};

resultsdir = '15sj_N-B_20pvox_60pROI_homo_ortho_05FDR_4-8fwhm/4fwhm';		% rename results directory here
...
ss=struct(...
    ...
    'Localizer_contrasts',{{'narr-base'}},...	% names of localizer contrasts in SPM struct
    'EffectOfInterest_contrasts',{{'narr', ...
								   'sent', ...
								   'word', ...
								   'base', ...
								   'sent-word', ...
								   'noun-verb', ...
								   'verb-noun'}},...		% names of effect of interest contrasts in SPM struct
